    ...
    <div class="reveal glass rounded-2xl overflow-hidden border border-slate-700/30 hover:border-accent-500/40 transition-all duration-300 group hover:-translate-y-1">
      ...
      <div class="p-6 space-y-4">
        ...
        <div class="flex gap-3 pt-1">
          ...
          <span
            title="Coming soon"
            class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-slate-800 border border-slate-700/40 text-xs font-semibold text-slate-600 cursor-not-allowed select-none opacity-60">
